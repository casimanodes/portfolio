...
export interface ApiAboutContentAboutContent extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Ueber mich Inhalte';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    portraitBadgeText: Schema.Attribute.String;
...
export interface ApiHeroContentHeroContent extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Hero-Bereich Inhalte';
...
export interface ApiPricePrice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Preisoptionen fuer Angebote';
    displayName: 'Price';
    pluralName: 'prices';
    singularName: 'price';
  };
...
export interface ApiScheduleSchedule extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    offerSlug: Schema.Attribute.String;
    price: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    spotsLeft: Schema.Attribute.Integer;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Globale Seiteneinstellungen';
  ...
  attributes: {
    ...
    siteSubtitle: Schema.Attribute.String;
...
export interface ApiThemenbereichThemenbereich
  extends Struct.CollectionTypeSchema {
  collectionName: 'themenbereiche';
  info: {
    description: 'Themenbereiche fuer Hero-Grid';
    displayName: 'Themenbereich';
    pluralName: 'themenbereiche';
    singularName: 'themenbereich';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::themenbereich.themenbereich': ApiThemenbereichThemenbereich;
